...
#include "updated_turtlebot3_node/diff_drive_controller.hpp"
#include "updated_turtlebot3_node/turtlebot3.hpp"

void help_print()
{
  printf("For updated turtlebot3 node : \n");
  printf("updated_turtlebot3_node [-i usb_port] [-h]\n");
  printf("options:\n");
